        ...
        this.products = [
            {
                ...
                heding2: 'サンプルテキスト2',
                heding3: 'サンプルテキスト3',
                hedingtext1: 'サンプルテキスト　サンプル　テキスト サンプルテキスト　サンプル　テキスト サンプルテキスト　サンプル　テキスト',
                hedingtext2: 'テキスト文章　テキスト文章　テキスト文章 テキスト文章　テキスト文章　テキスト文章 テキスト文章　テキスト文章　テキスト文章',
            ...
            },
            {
                ...
                heding2: 'サンプルテキスト2',
                heding3: 'サンプルテキスト3',
                hedingtext1: 'サンプルテキスト　サンプル　テキスト',
                hedingtext2: 'テキスト文章　テキスト文章　テキスト文章',
                hedingtext3: 'Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.'
            },
            {
                coverImage: './assets/img/phone-cover.jpg',
